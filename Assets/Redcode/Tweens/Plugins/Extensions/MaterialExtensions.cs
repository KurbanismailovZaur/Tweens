...
namespace Redcode.Tweens
{
    public static class MaterialExtensions
    {
        ...
        {
            return Tween.Float(material.color[axis], color, c => material.color = material.color.With(axis, c), duration, ease, loopsCount, loopType, direction).SetOwner(owner).SetName(owner.name);
        }
        ...
        {
            return Tween.Vector2(material.color.Get(channel1, channel2), new Vector2(value1, value2), c => material.color = material.color.With(channel1, c.x, channel2, c.y), duration, ease, loopsCount, loopType, direction).SetOwner(owner).SetName(owner.name);
        }
        ...
        {
            return Tween.Vector3(material.color.Get(channel1, channel2, channel3), new Vector3(value1, value2, value3), c => material.color = material.color.With(channel1, c.x, channel2, c.y, channel3, c.z), duration, ease, loopsCount, loopType, direction).SetOwner(owner).SetName(owner.name);
        }
        ...
        {
            return Tween.Float(material.GetColor(property)[channel], value, c => material.SetColor(property, material.GetColor(property).With(channel, c)), duration, ease, loopsCount, loopType, direction).SetOwner(owner).SetName(owner.name);
        }
        ...
        {
            return Tween.Vector2(material.GetColor(property).Get(channel1, channel2), new Vector2(value1, value2), c => material.SetColor(property, material.GetColor(property).With(channel1, c.x, channel2, c.y)), duration, ease, loopsCount, loopType, direction).SetOwner(owner).SetName(owner.name);
        }
        ...
        {
            return Tween.Vector3(material.GetColor(property).Get(channel1, channel2, channel3), new Vector3(value1, value2, value3), c => material.SetColor(property, material.GetColor(property).With(channel1, c.x, channel2, c.y, channel3, c.z)), duration, ease, loopsCount, loopType, direction).SetOwner(owner).SetName(owner.name);
        }
        ...
        {
            return Tween.Float(material.GetFloat(property), value, v => material.SetFloat(property, v), duration, ease, loopsCount, loopType, direction).SetOwner(owner).SetName(owner.name);
        }
        ...
        {
            return Tween.Int(material.GetInt(property), value, v => material.SetInt(property, v), duration, ease, loopsCount, loopType, direction).SetOwner(owner).SetName(owner.name);
        }
        ...
        {
            return Tween.Vector2(material.GetTextureScale(property), offset, o => material.SetTextureScale(property, o), duration, ease, loopsCount, loopType, direction);
        }
        #endregion
        ...
        {
            return Tween.Float(material.GetVector(property)[axis], value, v => material.SetVector(property, material.GetVector(property).With(axis, v)), duration, ease, loopsCount, loopType, direction).SetOwner(owner).SetName(owner.name);
        }
        ...
        {
            return Tween.Vector2(material.GetVector(property).With(axis1, axis2), new Vector2(value1, value2), v => material.SetVector(property, material.GetVector(property).With(axis1, v.x, axis2, v.y)), duration, ease, loopsCount, loopType, direction).SetOwner(owner).SetName(owner.name);
        }
        ...
        {
            return Tween.Vector3(material.GetVector(property).Get(axis1, axis2, axis3), new Vector3(value1, value2, value3), v => material.SetVector(property, material.GetVector(property).With(axis1, v.x, axis2, v.y, axis3, v.z)), duration, ease, loopsCount, loopType, direction).SetOwner(owner).SetName(owner.name);
        }
