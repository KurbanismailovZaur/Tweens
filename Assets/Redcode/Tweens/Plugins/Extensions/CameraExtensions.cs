...
namespace Tweens
{
    public static class CameraExtensions
    {
        ...
        public static Tween<float, TweakFloat> DoAspect(this Camera camera, GameObject owner, float aspect, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        private static Tween<float, TweakFloat> DoBackgroundColorOneAxis(Camera camera, GameObject owner, int axis, float color, float duration, FormulaBase formula, int loopsCount, LoopType loopType, Direction direction)
        {
        ...
        public static Tween<float, TweakFloat> DoBackgroundColorR(this Camera camera, GameObject owner, float r, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<float, TweakFloat> DoBackgroundColorG(this Camera camera, GameObject owner, float g, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<float, TweakFloat> DoBackgroundColorB(this Camera camera, GameObject owner, float b, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<float, TweakFloat> DoBackgroundColorA(this Camera camera, GameObject owner, float a, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        private static Sequence DoBackgroundColorTwoAxes(Camera camera, GameObject owner, int axis1, int axis2, float color1, float color2, float duration, FormulaBase formula, int loopsCount, LoopType loopType, LoopResetBehaviour loopResetBehaviour, Direction direction)
        {
        ...
        public static Sequence DoBackgroundColorRG(this Camera camera, GameObject owner, float r, float g, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, LoopResetBehaviour loopResetBehaviour = LoopResetBehaviour.Rewind, Direction direction = Direction.Forward)
        {
        ...
        public static Sequence DoBackgroundColorRB(this Camera camera, GameObject owner, float r, float b, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, LoopResetBehaviour loopResetBehaviour = LoopResetBehaviour.Rewind, Direction direction = Direction.Forward)
        {
        ...
        public static Sequence DoBackgroundColorRA(this Camera camera, GameObject owner, float r, float a, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, LoopResetBehaviour loopResetBehaviour = LoopResetBehaviour.Rewind, Direction direction = Direction.Forward)
        {
        ...
        public static Sequence DoBackgroundColorGB(this Camera camera, GameObject owner, float g, float b, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, LoopResetBehaviour loopResetBehaviour = LoopResetBehaviour.Rewind, Direction direction = Direction.Forward)
        {
        ...
        public static Sequence DoBackgroundColorGA(this Camera camera, GameObject owner, float g, float a, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, LoopResetBehaviour loopResetBehaviour = LoopResetBehaviour.Rewind, Direction direction = Direction.Forward)
        {
        ...
        public static Sequence DoBackgroundColorBA(this Camera camera, GameObject owner, float b, float a, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, LoopResetBehaviour loopResetBehaviour = LoopResetBehaviour.Rewind, Direction direction = Direction.Forward)
        {
        ...
        private static Sequence DoBackgroundColorThreeAxes(Camera camera, GameObject owner, int axis1, int axis2, int axis3, float color1, float color2, float color3, float duration, FormulaBase formula, int loopsCount, LoopType loopType, LoopResetBehaviour loopResetBehaviour, Direction direction)
        {
            var sequence = new Sequence(owner, owner.name, formula, loopsCount, loopType, loopResetBehaviour, direction);
        ...
        public static Sequence DoBackgroundColorRGB(this Camera camera, GameObject owner, float r, float g, float b, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, LoopResetBehaviour loopResetBehaviour = LoopResetBehaviour.Rewind, Direction direction = Direction.Forward)
        {
        ...
        public static Sequence DoBackgroundColorRGA(this Camera camera, GameObject owner, float r, float g, float a, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, LoopResetBehaviour loopResetBehaviour = LoopResetBehaviour.Rewind, Direction direction = Direction.Forward)
        {
        ...
        public static Sequence DoBackgroundColorRBA(this Camera camera, GameObject owner, float r, float b, float a, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, LoopResetBehaviour loopResetBehaviour = LoopResetBehaviour.Rewind, Direction direction = Direction.Forward)
        {
        ...
        public static Sequence DoBackgroundColorGBA(this Camera camera, GameObject owner, float g, float b, float a, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, LoopResetBehaviour loopResetBehaviour = LoopResetBehaviour.Rewind, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<Color, TweakColor> DoBackgroundColor(this Camera camera, GameObject owner, float r, float g, float b, float a, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<Color, TweakColor> DoBackgroundColor(this Camera camera, GameObject owner, Color color, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<float, TweakFloat> DoFarClipPlane(this Camera camera, GameObject owner, float distance, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<float, TweakFloat> DoNearClipPlane(this Camera camera, GameObject owner, float distance, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<float, TweakFloat> DoFieldOfView(this Camera camera, GameObject owner, float fov, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<float, TweakFloat> DoFocalLength(this Camera camera, GameObject owner, float focalLength, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        private static Tween<float, TweakFloat> DoLensShiftOneAxis(Camera camera, GameObject owner, int axis, float shift, float duration, FormulaBase formula, int loopsCount, LoopType loopType, Direction direction)
        {
        ...
        public static Tween<float, TweakFloat> DoLensShiftX(this Camera camera, GameObject owner, float x, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<float, TweakFloat> DoLensShiftY(this Camera camera, GameObject owner, float y, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        #region DoLensShift
        public static Tween<Vector2, TweakVector2> DoLensShift(this Camera camera, float x, float y, float duration, FormulaBase formula, int loopsCount, LoopType loopType, Direction direction)
        {
            return DoLensShift(camera, camera.gameObject, new Vector2(x, y), duration, formula, loopsCount, loopType, direction);
        }

        public static Tween<Vector2, TweakVector2> DoLensShift(this Camera camera, GameObject owner, float x, float y, float duration, FormulaBase formula, int loopsCount, LoopType loopType, Direction direction)
        {
            return DoLensShift(camera, owner, new Vector2(x, y), duration, formula, loopsCount, loopType, direction);
        }

        public static Tween<Vector2, TweakVector2> DoLensShift(this Camera camera, Vector2 shift, float duration, FormulaBase formula, int loopsCount, LoopType loopType, Direction direction)
        {
            return DoLensShift(camera, camera.gameObject, shift, duration, formula, loopsCount, loopType, direction);
        }

        public static Tween<Vector2, TweakVector2> DoLensShift(this Camera camera, GameObject owner, Vector2 shift, float duration, FormulaBase formula, int loopsCount, LoopType loopType, Direction direction)
        {
        ...
        public static Tween<float, TweakFloat> DoOrthographicSize(this Camera camera, GameObject owner, float size, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<Rect, TweakRect> DoPixelRect(this Camera camera, GameObject owner, Rect rect, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<Matrix4x4, TweakMatrix4x4> DoProjectionMatrix(this Camera camera, GameObject owner, Matrix4x4 matrix, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<Rect, TweakRect> DoRect(this Camera camera, GameObject owner, Rect rect, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        private static Tween<float, TweakFloat> DoSensorSizeOneAxis(this Camera camera, GameObject owner, int axis, float size, float duration, FormulaBase formula, int loopsCount, LoopType loopType, Direction direction)
        {
        ...
        public static Tween<float, TweakFloat> DoSensorSizeX(this Camera camera, GameObject owner, float x, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<float, TweakFloat> DoSensorSizeY(this Camera camera, GameObject owner, float y, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<Vector2, TweakVector2> DoSensorSize(this Camera camera, GameObject owner, float x, float y, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<Vector2, TweakVector2> DoSensorSize(this Camera camera, GameObject owner, Vector2 size, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<float, TweakFloat> DoStereoConvengence(this Camera camera, GameObject owner, float convengence, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<float, TweakFloat> DoStereoSeparation(this Camera camera, GameObject owner, float separation, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        private static Tween<float, TweakFloat> DoTransparencySortAxisOneAxis(Camera camera, GameObject owner, int axis, float value, float duration, FormulaBase formula, int loopsCount, LoopType loopType, Direction direction)
        {
        ...
        public static Tween<float, TweakFloat> DoTransparencySortAxisX(this Camera camera, GameObject owner, float r, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<float, TweakFloat> DoTransparencySortAxisY(this Camera camera, GameObject owner, float g, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<float, TweakFloat> DoTransparencySortAxisZ(this Camera camera, GameObject owner, float b, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        private static Sequence DoTransparencySortAxisTwoAxes(Camera camera, GameObject owner, int axis1, int axis2, float value1, float value2, float duration, FormulaBase formula, int loopsCount, LoopType loopType, LoopResetBehaviour loopResetBehaviour, Direction direction)
        {
            var sequence = new Sequence(owner, owner.name, formula, loopsCount, loopType, loopResetBehaviour, direction);
        ...
        public static Sequence DoTransparencySortAxisXY(this Camera camera, GameObject owner, float x, float y, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, LoopResetBehaviour loopResetBehaviour = LoopResetBehaviour.Rewind, Direction direction = Direction.Forward)
        {
        ...
        public static Sequence DoTransparencySortAxisXZ(this Camera camera, GameObject owner, float x, float z, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, LoopResetBehaviour loopResetBehaviour = LoopResetBehaviour.Rewind, Direction direction = Direction.Forward)
        {
        ...
        public static Sequence DoTransparencySortAxisYZ(this Camera camera, GameObject owner, float y, float z, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, LoopResetBehaviour loopResetBehaviour = LoopResetBehaviour.Rewind, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<Vector3, TweakVector3> DoTransparencySortAxis(this Camera camera, GameObject owner, float x, float y, float z, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
        ...
        public static Tween<Vector3, TweakVector3> DoTransparencySortAxis(this Camera camera, GameObject owner, Vector3 axis, float duration, FormulaBase formula = null, int loopsCount = 1, LoopType loopType = LoopType.Reset, Direction direction = Direction.Forward)
        {
